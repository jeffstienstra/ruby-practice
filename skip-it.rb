# Given an array of numbers, write a function that returns a new array in which only
# select numbers from the original array are included, based on the following details:
